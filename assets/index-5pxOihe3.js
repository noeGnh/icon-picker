const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["assets/style-QhTkZq0q.css"])))=>i.map(i=>d[i]);
...
var require_react = /* @__PURE__ */ __commonJSMin$1(((exports, module) => {
...
//#endregion
//#region ../react-icon-picker/dist/index.mjs
...
*/
var Icon$1 = (0, import_react.forwardRef)((props, ref) => IconComponent({
	...props,
	_ref: ref
}));
...
var DEFAULT_ICONIFY_API_BASE = "https://api.iconify.design";
/**
* A small, curated pool of well-known Iconify collections to pick a random
* default from when no iconLibrary restriction is set - picking from
* Iconify's full ~236-collection catalog risked landing on something
* obscure or low quality as the "surprise" default.
*/
var DEFAULT_BROWSABLE_PREFIXES = [
	"tabler",
	"carbon",
	"fa",
	"fluent",
...
async function searchIcons(query, options = {}) {
	...
	if (prefixes && prefixes.length) params.set("prefixes", prefixes.join(","));
	try {
		return ((await (await fetch(`${apiBase}/search?${params.toString()}`)).json()).icons ?? []).flatMap((name) => {
...
*/
async function browseCollection(prefix, options = {}) {
	const { limit, apiBase = DEFAULT_ICONIFY_API_BASE } = options;
	try {
		const data = await (await fetch(`${apiBase}/collection?prefix=${encodeURIComponent(prefix)}`)).json();
		const names = [...data.uncategorized ?? [], ...Object.values(data.categories ?? {}).flat()];
		return (typeof limit === "number" ? names.slice(0, limit) : names).map((icon) => ({
			name: `${prefix}:${icon}`,
			prefix,
			icon
		}));
...
*/
async function browseCollections(prefixes, options = {}) {
	if (!prefixes.length) return [];
	const perPrefixLimit = typeof options.limit === "number" ? Math.max(1, Math.floor(options.limit / prefixes.length)) : void 0;
	return (await Promise.all(prefixes.map((prefix) => browseCollection(prefix, {
		...options,
		limit: perPrefixLimit
	})))).flat();
}
/** Picks a random prefix from a small curated pool of well-known collections. */
function pickRandomPrefix(prefixes = DEFAULT_BROWSABLE_PREFIXES) {
	return prefixes[Math.floor(Math.random() * prefixes.length)];
}
function isIconSelected(value, candidateValue, multiple) {
	if (multiple) return Array.isArray(value) && value.includes(candidateValue);
...
*/
function toggleIconSelection(value, candidateValue, { multiple, multipleLimit, clearable }) {
	if (multiple) {
		...
		if (current.length >= multipleLimit) return void 0;
		return [...current, candidateValue];
	}
	if (value === candidateValue) return clearable ? null : void 0;
...
* escape hatch.
*/
function getSanitizedSvgFromCache(key) {
...
function setSanitizedSvgInCache(key, svg) {
	if (cache.size >= MAX_CACHE_SIZE) {
		const oldestKey = cache.keys().next().value;
		if (oldestKey) cache.delete(oldestKey);
	}
	const sanitized = purify.sanitize(svg, { USE_PROFILES: {
		svg: true,
		svgFilters: true
	} });
...
*/
async function resolveIconSvgValue(name, { loadIcon, buildIcon }) {
	const cached = getSanitizedSvgFromCache(name);
	if (cached) return cached;
	try {
		const built = buildIcon(await loadIcon(name));
		return setSanitizedSvgInCache(name, `<svg xmlns="http://www.w3.org/2000/svg" viewBox="${built.attributes.viewBox}">${built.body}</svg>`);
	} catch (error) {
		console.error(`Failed to load icon ${name}`, error);
		return;
	}
}
var Icon_module_default = { reactIconPickerIcon: "_reactIconPickerIcon_hpd6d_1" };
var Icon = ({ data, color, size = 24, style: restStyle, className: restClassName, ...restProps }) => {
	const computedSize = typeof size === "number" ? `${size}px` : size || "unset";
	const isRawSvg = (0, import_react.useMemo)(() => !!data && isSVG(data), [data]);
	const sanitizedSvg = (0, import_react.useMemo)(() => {
		if (!data || !isRawSvg) return "";
		return getSanitizedSvgFromCache(data) ?? setSanitizedSvgInCache(data, data);
	}, [data, isRawSvg]);
	if (data && !isRawSvg) return /* @__PURE__ */ (0, import_jsx_runtime$1.jsx)(Icon$1, {
		icon: data,
		color,
		width: size,
		height: size,
	...
	return /* @__PURE__ */ (0, import_jsx_runtime$1.jsx)("i", {
		className: `${Icon_module_default.reactIconPickerIcon} ${restClassName || ""}`,
		style: {
...
var Picker_module_default = {
	r3ipCustomSelect: "_r3ipCustomSelect_6e3bp_5",
	r3IpCustomSelect: "_r3ipCustomSelect_6e3bp_5",
	r3ipSelected: "_r3ipSelected_6e3bp_22",
	r3IpSelected: "_r3ipSelected_6e3bp_22",
	r3ipSmall: "_r3ipSmall_6e3bp_40",
	r3IpSmall: "_r3ipSmall_6e3bp_40",
	r3ipMedium: "_r3ipMedium_6e3bp_44",
	r3IpMedium: "_r3ipMedium_6e3bp_44",
	r3ipLarge: "_r3ipLarge_6e3bp_48",
	r3IpLarge: "_r3ipLarge_6e3bp_48",
	multiple: "_multiple_6e3bp_52",
	item: "_item_6e3bp_61",
	placeholder: "_placeholder_6e3bp_65",
	open: "_open_6e3bp_70",
	disabled: "_disabled_6e3bp_74",
	r3ipBadge: "_r3ipBadge_6e3bp_80",
	r3IpBadge: "_r3ipBadge_6e3bp_80",
	r3ipBadgeIcon: "_r3ipBadgeIcon_6e3bp_92",
	r3IpBadgeIcon: "_r3ipBadgeIcon_6e3bp_92",
	r3ipBadgeRemove: "_r3ipBadgeRemove_6e3bp_96",
	r3IpBadgeRemove: "_r3ipBadgeRemove_6e3bp_96",
	r3ipChevron: "_r3ipChevron_6e3bp_125",
	r3IpChevron: "_r3ipChevron_6e3bp_125",
	r3ipClearAll: "_r3ipClearAll_6e3bp_146",
	r3IpClearAll: "_r3ipClearAll_6e3bp_146",
	r3ipClear: "_r3ipClear_6e3bp_146",
	r3IpClear: "_r3ipClear_6e3bp_146",
	r3ipDropdown: "_r3ipDropdown_6e3bp_182",
	r3IpDropdown: "_r3ipDropdown_6e3bp_182",
	r3ipDropdownOpen: "_r3ipDropdownOpen_6e3bp_201",
	r3IpDropdownOpen: "_r3ipDropdownOpen_6e3bp_201",
	r3ipItems: "_r3ipItems_6e3bp_207",
	r3IpItems: "_r3ipItems_6e3bp_207",
	r3ipGridItem: "_r3ipGridItem_6e3bp_213",
	r3IpGridItem: "_r3ipGridItem_6e3bp_213",
	active: "_active_6e3bp_235",
	r3ipSearch: "_r3ipSearch_6e3bp_240",
	r3IpSearch: "_r3ipSearch_6e3bp_240",
	r3ipSearchIcon: "_r3ipSearchIcon_6e3bp_248",
	r3IpSearchIcon: "_r3ipSearchIcon_6e3bp_248",
	r3ipMeta: "_r3ipMeta_6e3bp_276",
	r3IpMeta: "_r3ipMeta_6e3bp_276",
	r3ipEmpty: "_r3ipEmpty_6e3bp_283",
	r3IpEmpty: "_r3ipEmpty_6e3bp_283",
	defaultText: "_defaultText_6e3bp_289",
	r3ipDark: "_r3ipDark_6e3bp_294",
	r3IpDark: "_r3ipDark_6e3bp_294"
};
var Picker = ({ value, onChange, searchPlaceholder = "Search", placeholder, multiple = false, iconLibrary, selectedIconBgColor = "transparent", selectedIconColor = "#2b5fe0", displaySearch = true, multipleLimit = Infinity, disabled = false, selectedItemsToDisplay = 9, clearable = false, valueType = "name", includeIcons = [], excludeIcons = [], emptyText = "Nothing to show", inputSize = "medium", theme = "light", emptySlot, style: restStyle, className: restClassName }) => {
	const [searchQuery, setSearchQuery] = (0, import_react.useState)("");
	const [open, setOpen] = (0, import_react.useState)(false);
	const [filteredIcons, setFilteredIcons] = (0, import_react.useState)([]);
	const [isLoading, setIsLoading] = (0, import_react.useState)(false);
	const [resultVersion, setResultVersion] = (0, import_react.useState)(0);
	const pickerRef = (0, import_react.useRef)(null);
	const scrollerObserverRef = (0, import_react.useRef)(null);
	const [scrollerWidth, setScrollerWidth] = (0, import_react.useState)(0);
	const scrollerRef = (0, import_react.useCallback)((node) => {
	...
	const normalizedPrefixesList = iconLibrary ? Array.isArray(iconLibrary) ? iconLibrary : [iconLibrary] : [];
	const normalizedPrefixes = normalizedPrefixesList.length ? normalizedPrefixesList : void 0;
	const randomDefaultPrefixRef = (0, import_react.useRef)(void 0);
	const applyLocalFilters = (results) => results.filter((icon) => {
	...
	const fetchDefaultIcons = async () => {
		...
		} else if (normalizedPrefixes.length === 1) return browseCollection(normalizedPrefixes[0]);
	...
	const runSearch = async (query) => {
		...
		setIsLoading(true);
		try {
			const results = query.trim() ? await searchIcons(query, { prefixes: normalizedPrefixes }) : await fetchDefaultIcons();
	...
	(0, import_react.useEffect)(() => {
		...
		searchQuery,
		JSON.stringify(normalizedPrefixes),
		JSON.stringify(includeIcons),
		JSON.stringify(excludeIcons)
	]);
	const statusText = isLoading ? "Loading…" : "";
	const clearSearch = () => setSearchQuery("");
	/** Resolves the value to store for a freshly selected icon (async for valueType: 'svg'). */
	const getResolvedValue = (0, import_react.useCallback)(async (icon) => {
		if (valueType === "name") return icon.name;
		return resolveIconSvgValue(icon.name, {
			loadIcon,
			buildIcon: iconToSVG
		});
	}, [valueType]);
	const applyToggle = (0, import_react.useCallback)((candidateValue) => {
	...
	const onGridItemSelected = (0, import_react.useCallback)(async (icon) => {
	...
	const onBadgeRemove = (0, import_react.useCallback)((badgeValue) => {
		applyToggle(badgeValue);
	}, [applyToggle]);
	const clearAll = (0, import_react.useCallback)(() => {
		onChange(multiple ? [] : null);
	}, [multiple, onChange]);
	const isGridIconSelected = (0, import_react.useCallback)((icon) => {
		if (valueType === "name") return isIconSelected(value, icon.name, multiple);
		const cached = getSanitizedSvgFromCache(icon.name);
		if (!cached) return false;
		return isIconSelected(value, cached, multiple);
	}, [
		valueType,
		value,
		multiple
	...
	const Cell = ({ ariaAttributes, columnIndex, rowIndex, style }) => {
		...
		return /* @__PURE__ */ (0, import_jsx_runtime$1.jsx)("button", {
			...
			...ariaAttributes,
			style,
			className: `${Picker_module_default.r3ipGridItem} ${isGridIconSelected(item) ? Picker_module_default.active : ""}`,
			title: item.name,
			"aria-pressed": isGridIconSelected(item),
			onClick: () => onGridItemSelected(item),
			children: /* @__PURE__ */ (0, import_jsx_runtime$1.jsx)(Icon, {
				data: item.name,
				size: 14,
				color: isGridIconSelected(item) ? selectedIconColor : theme === "dark" ? "#f2f2f3" : "#111114"
			})
		});
	};
	return /* @__PURE__ */ (0, import_jsx_runtime$1.jsxs)("div", {
		ref: pickerRef,
		className: `${Picker_module_default.r3ipCustomSelect} ${Picker_module_default[`r3ip${inputSize.charAt(0).toUpperCase() + inputSize.slice(1)}`]} ${Picker_module_default[`r3ip${theme.charAt(0).toUpperCase() + theme.slice(1)}`]} ${restClassName}`,
		style: {
		...
		children: [/* @__PURE__ */ (0, import_jsx_runtime$1.jsxs)("div", {
			className: `${Picker_module_default.r3ipSelected} ${open ? Picker_module_default.open : ""} ${disabled ? Picker_module_default.disabled : ""}`,
			role: "button",
			"aria-expanded": open,
			tabIndex: disabled ? -1 : 0,
			onClick: handleToggle,
			onKeyDown: onTriggerKeyDown,
			children: [!multiple && value || multiple && Array.isArray(value) && value.length ? /* @__PURE__ */ (0, import_jsx_runtime$1.jsx)(import_jsx_runtime$1.Fragment, { children: multiple ? /* @__PURE__ */ (0, import_jsx_runtime$1.jsxs)("div", {
				className: Picker_module_default.multiple,
				children: [
					Array.isArray(value) && value.map((val, i) => /* @__PURE__ */ (0, import_jsx_runtime$1.jsx)(import_react.Fragment, { children: i < selectedItemsToDisplay && /* @__PURE__ */ (0, import_jsx_runtime$1.jsxs)("span", {
						className: Picker_module_default.r3ipBadge,
						children: [/* @__PURE__ */ (0, import_jsx_runtime$1.jsx)(Icon, {
							className: Picker_module_default.r3ipBadgeIcon,
							data: val,
							size: 12,
							color: theme === "dark" ? "#f2f2f3" : "#111114"
						}), /* @__PURE__ */ (0, import_jsx_runtime$1.jsx)("button", {
							type: "button",
							className: Picker_module_default.r3ipBadgeRemove,
							title: "Remove",
							onClick: (e) => {
								e.stopPropagation();
								onBadgeRemove(val);
					...
					Array.isArray(value) && value.length > selectedItemsToDisplay && /* @__PURE__ */ (0, import_jsx_runtime$1.jsx)("div", {
						className: Picker_module_default.item,
						children: /* @__PURE__ */ (0, import_jsx_runtime$1.jsxs)("b", { children: ["+", value.length - selectedItemsToDisplay] })
					}),
					Array.isArray(value) && value.length > 0 && /* @__PURE__ */ (0, import_jsx_runtime$1.jsx)("button", {
						type: "button",
						className: Picker_module_default.r3ipClearAll,
						title: "Clear all",
						onClick: (e) => {
							e.stopPropagation();
							clearAll();
				...
				children: [/* @__PURE__ */ (0, import_jsx_runtime$1.jsx)(Icon, {
					...
					size: 12,
					color: theme === "dark" ? "#f2f2f3" : "#111114"
				}), clearable && /* @__PURE__ */ (0, import_jsx_runtime$1.jsx)("button", {
					type: "button",
					className: Picker_module_default.r3ipBadgeRemove,
					title: "Remove",
					onClick: (e) => {
				...
				className: Picker_module_default.placeholder,
				...
				children: /* @__PURE__ */ (0, import_jsx_runtime$1.jsx)("svg", {
					...
					strokeLinecap: "round",
					strokeLinejoin: "round",
					children: /* @__PURE__ */ (0, import_jsx_runtime$1.jsx)("polyline", { points: "6 9 12 15 18 9" })
				})
			})]
		}), /* @__PURE__ */ (0, import_jsx_runtime$1.jsxs)("div", {
			className: `${Picker_module_default.r3ipDropdown} ${open ? Picker_module_default.r3ipDropdownOpen : ""}`,
			children: [
				displaySearch && /* @__PURE__ */ (0, import_jsx_runtime$1.jsxs)("div", {
					className: Picker_module_default.r3ipSearch,
					children: [
						...
						searchQuery && /* @__PURE__ */ (0, import_jsx_runtime$1.jsx)("button", {
							type: "button",
							className: Picker_module_default.r3ipClear,
							title: "Clear search",
							onClick: clearSearch,
							children: /* @__PURE__ */ (0, import_jsx_runtime$1.jsxs)("svg", {
								width: 11,
				...
				statusText && /* @__PURE__ */ (0, import_jsx_runtime$1.jsx)("div", {
					className: Picker_module_default.r3ipMeta,
					children: statusText
				}),
				filteredIcons && filteredIcons.length ? /* @__PURE__ */ (0, import_jsx_runtime$1.jsx)("div", {
					...
					children: scrollerWidth > 0 && /* @__PURE__ */ (0, import_jsx_runtime$1.jsx)(Ve, {
						...
						rowHeight,
						style: {
							height: Math.min(216, rowCount * rowHeight),
							width: scrollerWidth
						}
					}, resultVersion)
				}) : /* @__PURE__ */ (0, import_jsx_runtime$1.jsx)("div", {
					className: Picker_module_default.r3ipEmpty,
					children: emptySlot || /* @__PURE__ */ (0, import_jsx_runtime$1.jsx)("div", {
						className: Picker_module_default.defaultText,
						children: /* @__PURE__ */ (0, import_jsx_runtime$1.jsx)("small", { children: emptyText })
					})
				})
			]
		})]
...
var App = () => {
	...
	const [clearable, setClearable] = (0, import_react.useState)(false);
	const [multipleSelection, setMultipleSelection] = (0, import_react.useState)(false);
	const [selectedLibraries, setSelectedLibraries] = (0, import_react.useState)(["tabler"]);
	const [inputSize, setInputSize] = (0, import_react.useState)("medium");
	const isSelected = (lib) => selectedLibraries.includes(lib);
	...
	const toggleMultipleSelection = () => {
		...
		if (!multipleSelection) setClearable(false);
	};
	...
	return /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
		className: `playground ${darkMode ? "dark" : ""}`,
		children: /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("section", {
			className: "playground-card",
			children: [
				/* @__PURE__ */ (0, import_jsx_runtime.jsx)("p", {
					className: "eyebrow",
					children: "@arkn/react-icon-picker"
				}),
				/* @__PURE__ */ (0, import_jsx_runtime.jsx)("h1", { children: "Playground" }),
				/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
					...
					children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("p", {
						...
						className: "chips",
						children: ICON_LIBRARIES.map((lib) => /* @__PURE__ */ (0, import_jsx_runtime.jsx)("button", {
							type: "button",
