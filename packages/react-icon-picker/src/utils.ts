...
/**
 * Custom hook to load icons list.
 *
 ...
 * - iconsList: Icon[] - the list of icons
 * - prepareData: () => Promise<Icon[]> - a function to fetch/refetch the list
 *
 * @returns {{ iconsList: Icon[], prepareData: () => Promise<Icon[]> }}
 */
